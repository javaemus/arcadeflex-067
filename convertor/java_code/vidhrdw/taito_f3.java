...
public class taito_f3
{
	...
	*/
	...
	static int dpix_2a(UINT32 s_pix)
	{
		...
		if(s_pix)
		{
			if (p1 == 0)				{f3_alpha_blend_2a_0(s_pix);if(pdest_2a) pval |= pdest_2a;else return 1;}
		...
		{
			if (p1 == 0)				{dval = s_pix;if(pdest_2a) pval |= pdest_2a;else return 1;}
	...
	static int dpix_3a(UINT32 s_pix)
	{
		...
		if(s_pix)
		{
			if (p1 == 0)				{f3_alpha_blend_3a_0(s_pix);if(pdest_3a) pval |= pdest_3a;else return 1;}
		...
		{
			if (p1 == 0)				{dval = s_pix;if(pdest_3a) pval |= pdest_3a;else return 1;}
	...
	static int dpix_2b(UINT32 s_pix)
	{
		...
		if(s_pix)
		{
			if (p1 == 0)				{f3_alpha_blend_2b_0(s_pix);if(pdest_2b) pval |= pdest_2b;else return 1;}
		...
		{
			if (p1 == 0)				{dval = s_pix;if(pdest_2b) pval |= pdest_2b;else return 1;}
	...
	static int dpix_3b(UINT32 s_pix)
	{
		...
		if(s_pix)
		{
			if (p1 == 0)				{f3_alpha_blend_3b_0(s_pix);if(pdest_3b) pval |= pdest_3b;else return 1;}
		...
		{
			if (p1 == 0)				{dval = s_pix;if(pdest_3b) pval |= pdest_3b;else return 1;}
