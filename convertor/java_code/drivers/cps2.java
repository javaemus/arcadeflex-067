...
public class cps2
{
	...
	*/
	...
	static RomLoadPtr rom_choko = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_jgokushi = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	static RomLoadPtr rom_progear = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( CODE_SIZE, REGION_CPU1, 0 );     /* 68000 code */
	...
	public static GameDriver driver_rckmanj	   = new GameDriver("1995"	,"rckmanj"	,"cps2.java"	,rom_rckmanj,null	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0	,	"Capcom", "Rockman: The Power Battle (Japan 950922)", GAME_NOT_WORKING )
	...
	public static GameDriver driver_sfar1	   = new GameDriver("1995"	,"sfar1"	,"cps2.java"	,rom_sfar1,driver_sfa	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0	,	"Capcom", "Street Fighter Alpha: Warriors' Dreams (Euro 950718)", GAME_NOT_WORKING )
	...
	public static GameDriver driver_xmvsfjr1	   = new GameDriver("1996"	,"xmvsfjr1"	,"cps2.java"	,rom_xmvsfjr1,driver_xmvsf	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0	,	"Capcom", "X-Men Vs. Street Fighter (Japan 960909)", GAME_NOT_WORKING )
	...
	public static GameDriver driver_cscluba	   = new GameDriver("1997"	,"cscluba"	,"cps2.java"	,rom_cscluba,null	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0	,	"Capcom", "Capcom Sports Club (Asia 970722)" )
	public static GameDriver driver_csclubj	   = new GameDriver("1997"	,"csclubj"	,"cps2.java"	,rom_csclubj,driver_cscluba	,machine_driver_cps2	,input_ports_sgemf	,init_cps2	,ROT0	,	"Capcom", "Capcom Sports Club (Japan 970722)" )
	...
	public static GameDriver driver_vhunt2	   = new GameDriver("1997"	,"vhunt2"	,"cps2.java"	,rom_vhunt2,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0	,	"Capcom", "Vampire Hunter 2: Darkstalkers Revenge (Japan 970913)" )
	...
	public static GameDriver driver_jgokushi	   = new GameDriver("1999"	,"jgokushi"	,"cps2.java"	,rom_jgokushi,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0	,	"Capcom", "Jyangokushi: Haoh no Saihai (Japan 990527)", GAME_NOT_WORKING )
	...
	public static GameDriver driver_mpangj	   = new GameDriver("2000"	,"mpangj"	,"cps2.java"	,rom_mpangj,null	,machine_driver_cps2	,input_ports_ssf2	,init_cps2	,ROT0	,	"Mitchell, distributed by Capcom", "Mighty! Pang (Japan 001011)", GAME_NOT_WORKING )
	public static GameDriver driver_choko	   = new GameDriver("2001"	,"choko"	,"cps2.java"	,rom_choko,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0	,	"Mitchell, distributed by Capcom", "Choko (Japan 010820)", GAME_NOT_WORKING )
	public static GameDriver driver_puzloop2	   = new GameDriver("2001"	,"puzloop2"	,"cps2.java"	,rom_puzloop2,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0	,	"Mitchell, distributed by Capcom", "Puzz Loop 2 (Japan 010205)", GAME_NOT_WORKING )
	
	/* Games released on CPS-2 hardware by Eighting/Raizing */
	
	public static GameDriver driver_dimahoo	   = new GameDriver("2000"	,"dimahoo"	,"cps2.java"	,rom_dimahoo,null	,machine_driver_dima	,input_ports_sgemf	,init_cps2	,ROT270	,	"Eighting/Raizing, distributed by Capcom", "Dimahoo (US 000121)" )
	public static GameDriver driver_gmahou	   = new GameDriver("2000"	,"gmahou"	,"cps2.java"	,rom_gmahou,driver_dimahoo	,machine_driver_dima	,input_ports_sgemf	,init_cps2	,ROT270	,	"Eighting/Raizing, distributed by Capcom", "Great Mahou Daisakusen (Japan 000121)" )
	...
	public static GameDriver driver_progear	   = new GameDriver("2001"	,"progear"	,"cps2.java"	,rom_progear,null	,machine_driver_cps2	,input_ports_cps2	,init_cps2	,ROT0	,	"Cave, distributed by Capcom", "Progear no Arashi (Japan 010117)", GAME_NOT_WORKING )
}
