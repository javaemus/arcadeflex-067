...
public class legionna
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_legionna	   = new GameDriver("1992"	,"legionna"	,"legionna.java"	,rom_legionna,null	,machine_driver_legionna	,input_ports_legionna	,init_legionna	,ROT0	,	"Tad", "Legionnaire (World)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_legionnu	   = new GameDriver("1992"	,"legionnu"	,"legionna.java"	,rom_legionnu,driver_legionna	,machine_driver_legionna	,input_ports_legionna	,init_legionna	,ROT0	,	"Tad (Fabtek license)", "Legionnaire (US)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_heatbrl	   = new GameDriver("1992"	,"heatbrl"	,"legionna.java"	,rom_heatbrl,null	,machine_driver_heatbrl	,input_ports_heatbrl	,null	,ROT0	,	"Tad", "Heated Barrel (World)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_heatbrlo	   = new GameDriver("1992"	,"heatbrlo"	,"legionna.java"	,rom_heatbrlo,driver_heatbrl	,machine_driver_heatbrl	,input_ports_heatbrl	,null	,ROT0	,	"Tad", "Heated Barrel (World old version)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_heatbrlu	   = new GameDriver("1992"	,"heatbrlu"	,"legionna.java"	,rom_heatbrlu,driver_heatbrl	,machine_driver_heatbrl	,input_ports_heatbrl	,null	,ROT0	,	"Tad", "Heated Barrel (US)", GAME_UNEMULATED_PROTECTION )
}
