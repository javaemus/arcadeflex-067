...
public class midtunit
{
	...
	static InputPortPtr input_ports_jdredd = new InputPortPtr(){ public void handler() { 
		PORT_START(); 
		PORT_BIT( 0x0001, IP_ACTIVE_LOW, IPT_JOYSTICK_UP    | IPF_PLAYER1 | IPF_8WAY );
		PORT_BIT( 0x0002, IP_ACTIVE_LOW, IPT_JOYSTICK_DOWN  | IPF_PLAYER1 | IPF_8WAY );
		PORT_BIT( 0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 | IPF_8WAY );
	...
	*/
	...
	public static GameDriver driver_jdredd	   = new GameDriver("1993"	,"jdredd"	,"midtunit.java"	,rom_jdredd,null	,machine_driver_tunit_adpcm	,input_ports_jdredd	,init_jdredd	,ROT0	,	"Midway",   "Judge Dredd (rev LA1, prototype)" )
	...
	public static GameDriver driver_nbajamte	   = new GameDriver("1994"	,"nbajamte"	,"midtunit.java"	,rom_nbajamte,driver_nbajam	,machine_driver_tunit_adpcm	,input_ports_nbajam	,init_nbajamte	,ROT0	,	"Midway",   "NBA Jam TE (rev 4.0 03/23/94)" )
	public static GameDriver driver_nbajamt1	   = new GameDriver("1994"	,"nbajamt1"	,"midtunit.java"	,rom_nbajamt1,driver_nbajam	,machine_driver_tunit_adpcm	,input_ports_nbajam	,init_nbajamte	,ROT0	,	"Midway",   "NBA Jam TE (rev 1.0 01/17/94)" )
	public static GameDriver driver_nbajamt2	   = new GameDriver("1994"	,"nbajamt2"	,"midtunit.java"	,rom_nbajamt2,driver_nbajam	,machine_driver_tunit_adpcm	,input_ports_nbajam	,init_nbajamte	,ROT0	,	"Midway",   "NBA Jam TE (rev 2.0 01/28/94)" )
	public static GameDriver driver_nbajamt3	   = new GameDriver("1994"	,"nbajamt3"	,"midtunit.java"	,rom_nbajamt3,driver_nbajam	,machine_driver_tunit_adpcm	,input_ports_nbajam	,init_nbajamte	,ROT0	,	"Midway",   "NBA Jam TE (rev 3.0 03/04/94)" )
}
