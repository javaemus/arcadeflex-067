...
public class rungun
{
	...
	public static GameDriver driver_rungun	   = new GameDriver("1993"	,"rungun"	,"rungun.java"	,rom_rungun,null	,machine_driver_rng	,input_ports_rng	,null	,ROT0	,	"Konami", "Run and Gun (World ver. EAA)", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_COLORS )
	public static GameDriver driver_rungunu	   = new GameDriver("1993"	,"rungunu"	,"rungun.java"	,rom_rungunu,driver_rungun	,machine_driver_rng	,input_ports_rng	,null	,ROT0	,	"Konami", "Run and Gun (US ver. UAB)", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_COLORS )
	public static GameDriver driver_slmdunkj	   = new GameDriver("1993"	,"slmdunkj"	,"rungun.java"	,rom_slmdunkj,driver_rungun	,machine_driver_rng	,input_ports_rng	,null	,ROT0	,	"Konami", "Slam Dunk (Japan ver. JAA))", GAME_NOT_WORKING | GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_COLORS )
}
