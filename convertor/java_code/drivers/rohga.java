...
public class rohga
{
	...
	static RomLoadPtr rom_nitrobal = new RomLoadPtr(){ public void handler(){  /* Todo - rename these roms to correct DE codes */
		ROM_REGION(0x200000, REGION_CPU1, 0 );/* 68000 code */
	...
	public static GameDriver driver_rohga	   = new GameDriver("1991"	,"rohga"	,"rohga.java"	,rom_rohga,null	,machine_driver_rohga	,input_ports_rohga	,init_rohga	,ROT0	,	"Data East Corporation", "Rohga Armour Force (Asia/Europe v3.0)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_rohgah	   = new GameDriver("1991"	,"rohgah"	,"rohga.java"	,rom_rohgah,driver_rohga	,machine_driver_rohga	,input_ports_rohga	,init_rohga	,ROT0	,	"Data East Corporation", "Rohga Armour Force (Hong Kong v3.0)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_rohgau	   = new GameDriver("1991"	,"rohgau"	,"rohga.java"	,rom_rohgau,driver_rohga	,machine_driver_rohga	,input_ports_rohga	,init_rohga	,ROT0	,	"Data East Corporation", "Rohga Armour Force (US v1.0)", GAME_UNEMULATED_PROTECTION )
	...
	public static GameDriver driver_nitrobal	   = new GameDriver("1992"	,"nitrobal"	,"rohga.java"	,rom_nitrobal,null	,machine_driver_nitrobal	,input_ports_rohga	,init_nitrobal	,ROT270	,	"Data East Corporation", "Nitro Ball (US)", GAME_UNEMULATED_PROTECTION )
}
