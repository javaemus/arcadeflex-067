...
public class itech32
{
	...
	static RomLoadPtr rom_wcbowl = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );
	...
	public static GameDriver driver_pairs	   = new GameDriver("1994"	,"pairs"	,"itech32.java"	,rom_pairs,null	,machine_driver_pairs	,input_ports_pairs	,init_bloodstm	,ROT0	,	"Strata/Incredible Technologies", "Pairs (09/07/94)" )
	...
	public static GameDriver driver_wcbowl	   = new GameDriver("1995"	,"wcbowl"	,"itech32.java"	,rom_wcbowl,null	,machine_driver_wcbowl	,input_ports_wcbowl	,init_wcbowl	,ROT0	,	"Incredible Technologies", "World Class Bowling (v1.2)" )
	...
	public static GameDriver driver_shufshot	   = new GameDriver("1997"	,"shufshot"	,"itech32.java"	,rom_shufshot,null	,machine_driver_sftm	,input_ports_shufshot	,init_shufshot	,ROT0	,	"Strata/Incredible Technologies", "Shuffleshot (v1.39)" )
}
