...
public class atarigx2
{
	...
	public static GameDriver driver_rrreveng	   = new GameDriver("1994"	,"rrreveng"	,"atarigx2.java"	,rom_rrreveng,null	,machine_driver_atarigx2	,input_ports_rrreveng	,init_rrreveng	,ROT0	,	"Atari Games", "Road Riot's Revenge (prototype)", GAME_UNEMULATED_PROTECTION )
}
