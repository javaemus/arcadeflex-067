...
public class ojankohs
{
	...
	public static ReadHandlerPtr io_ccasino_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
		int ret;
	...
	public static IO_ReadPort readport_ccasino[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_ReadPort( 0x0000, 0xffff, io_ccasino_r ),
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	
	public static WriteHandlerPtr io_ccasino_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		offset = (((offset & 0xff00) >> 8) | ((offset & 0x00ff) << 8));
	...
	public static IO_WritePort writeport_ccasino[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_WritePort( 0x0000, 0xffff, io_ccasino_w ),
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
