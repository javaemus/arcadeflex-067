...
public class system32
{
	...
	public static Memory_ReadAddress jpcab_readmem[]={
		...
		new Memory_ReadAddress( 0xc000, 0xc000, jpcab_z80_read ),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	...
	public static IO_ReadPort jpcab_readport[]={
		new IO_ReadPort(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_ReadPort( 0x4, 0x4, IORP_NOP ),		// interrupt control
		new IO_ReadPort(MEMPORT_MARKER, 0)
	};
	
	public static IO_WritePort jpcab_writeport[]={
		new IO_WritePort(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_IO | MEMPORT_WIDTH_8),
		new IO_WritePort( 0x4, 0x4, IOWP_NOP ),
		new IO_WritePort(MEMPORT_MARKER, 0)
	};
	...
	*/
	...
	public static GameDriver driver_holo	   = new GameDriver("1992"	,"holo"	,"system32.java"	,rom_holo,null	,machine_driver_system32	,input_ports_holo	,init_holo	,ROT0	,	"Sega", "Holosseum" ) /* fine */
	
	/* these have a range of issues, mainly with the backgrounds */
	public static GameDriver driver_svf	   = new GameDriver("1994"	,"svf"	,"system32.java"	,rom_svf,null	,machine_driver_system32	,input_ports_svf	,init_s32	,ROT0	,	"Sega", "Super Visual Football", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_svs	   = new GameDriver("1994"	,"svs"	,"system32.java"	,rom_svs,driver_svf	,machine_driver_system32	,input_ports_svf	,init_s32	,ROT0	,	"Sega", "Super Visual Soccer (US?)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_jleague	   = new GameDriver("1994"	,"jleague"	,"system32.java"	,rom_jleague,driver_svf	,machine_driver_system32	,input_ports_svf	,init_s32	,ROT0	,	"Sega", "The J.League 94 (Japan)", GAME_NOT_WORKING | GAME_UNEMULATED_PROTECTION )
	...
	public static GameDriver driver_radm	   = new GameDriver("1990"	,"radm"	,"system32.java"	,rom_radm,null	,machine_driver_system32	,input_ports_radm	,init_radm	,ROT0	,	"Sega", "Rad Mobile", GAME_IMPERFECT_GRAPHICS )
	...
	public static GameDriver driver_f1en	   = new GameDriver("199?"	,"f1en"	,"system32.java"	,rom_f1en,null	,machine_driver_system32	,input_ports_f1en	,init_f1en	,ROT0	,	"Sega", "F1 Exhaust Note", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_alien3	   = new GameDriver("1993"	,"alien3"	,"system32.java"	,rom_alien3,null	,machine_driver_system32	,input_ports_alien3	,init_alien3	,ROT0	,	"Sega", "Alien 3", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_sonic	   = new GameDriver("1992"	,"sonic"	,"system32.java"	,rom_sonic,null	,machine_driver_sys32_hi	,input_ports_sonic	,init_sonic	,ROT0	,	"Sega", "Sonic (Japan rev. C)", GAME_NOT_WORKING | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_sonicp	   = new GameDriver("1992"	,"sonicp"	,"system32.java"	,rom_sonicp,driver_sonic	,machine_driver_sys32_hi	,input_ports_sonic	,init_sonic	,ROT0	,	"Sega", "Sonic (Japan prototype)", GAME_IMPERFECT_GRAPHICS )
	...
	public static GameDriver driver_spidey	   = new GameDriver("1991"	,"spidey"	,"system32.java"	,rom_spidey,null	,machine_driver_system32	,input_ports_spidey	,init_spidey	,ROT0	,	"Sega", "Spiderman (US)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_spideyj	   = new GameDriver("1991"	,"spideyj"	,"system32.java"	,rom_spideyj,driver_spidey	,machine_driver_system32	,input_ports_spideyj	,init_spidey	,ROT0	,	"Sega", "Spiderman (Japan)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_arabfgt	   = new GameDriver("1991"	,"arabfgt"	,"system32.java"	,rom_arabfgt,null	,machine_driver_system32	,input_ports_spidey	,init_arf	,ROT0	,	"Sega", "Arabian Fight", GAME_IMPERFECT_GRAPHICS )
	
	/* not really working */
	public static GameDriver driver_f1lap	   = new GameDriver("199?"	,"f1lap"	,"system32.java"	,rom_f1lap,null	,machine_driver_system32	,input_ports_system32	,init_f1sl	,ROT0	,	"Sega", "F1 Super Lap", GAME_NOT_WORKING ) /* blank screen, also requires 2 linked sys32 boards to function */
	public static GameDriver driver_dbzvrvs	   = new GameDriver("199?"	,"dbzvrvs"	,"system32.java"	,rom_dbzvrvs,null	,machine_driver_sys32_hi	,input_ports_system32	,init_s32	,ROT0	,	"Sega", "Dragon Ball Z VRVS", GAME_NOT_WORKING | GAME_UNEMULATED_PROTECTION) /* does nothing useful, known to be heavily protected */
	public static GameDriver driver_darkedge	   = new GameDriver("1992"	,"darkedge"	,"system32.java"	,rom_darkedge,null	,machine_driver_sys32_hi	,input_ports_system32	,init_s32	,ROT0	,	"Sega", "Dark Edge", GAME_NOT_WORKING | GAME_UNEMULATED_PROTECTION ) /* locks up on some levels, sprites are submerged, protected */
	/* Air Rescue */
	/* Loony Toons (maybe) */
