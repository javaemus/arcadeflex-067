...
public class vsnes
{
	...
	*/
	...
	public static GameDriver driver_machridr	   = new GameDriver("1985"	,"machridr"	,"vsnes.java"	,rom_machridr,null	,machine_driver_vsnes	,input_ports_machridr	,init_machridr	,ROT0	,	"Nintendo",  "Vs. Mach Rider (Endurance Course Version)" )
	public static GameDriver driver_machridj	   = new GameDriver("1985"	,"machridj"	,"vsnes.java"	,rom_machridj,driver_machridr	,machine_driver_vsnes	,input_ports_machridj	,init_vspinbal	,ROT0	,	"Nintendo",  "Vs. Mach Rider (Japan, Fighting Course Version)" )
	public static GameDriver driver_rbibb	   = new GameDriver("1986"	,"rbibb"	,"vsnes.java"	,rom_rbibb,null	,machine_driver_vsnes	,input_ports_rbibb	,init_rbibb	,ROT0	,	"Namco",     "Vs. Atari R.B.I. Baseball" )
	...
	public static GameDriver driver_vsskykid	   = new GameDriver("1985"	,"vsskykid"	,"vsnes.java"	,rom_vsskykid,null	,machine_driver_vsnes	,input_ports_vsskykid	,init_vsskykid	,ROT0	,	"Namco",     "Vs. Super SkyKid"  )
	public static GameDriver driver_tkoboxng	   = new GameDriver("1987"	,"tkoboxng"	,"vsnes.java"	,rom_tkoboxng,null	,machine_driver_vsnes	,input_ports_tkoboxng	,init_tkoboxng	,ROT0	,	"Namco LTD.","Vs. TKO Boxing", GAME_WRONG_COLORS )
	...
	public static GameDriver driver_vsslalom	   = new GameDriver("1986"	,"vsslalom"	,"vsnes.java"	,rom_vsslalom,null	,machine_driver_vsnes	,input_ports_vsslalom	,init_vsslalom	,ROT0	,	"Rare LTD.", "Vs. Slalom" )
	...
	public static GameDriver driver_jajamaru	   = new GameDriver("1985"	,"jajamaru"	,"vsnes.java"	,rom_jajamaru,null	,machine_driver_vsnes	,input_ports_jajamaru	,init_jajamaru	,ROT0	,	"Jaleco",    "Vs. Ninja Jajamaru Kun (Japan)" )
	...
	/* Not Working */
	public static GameDriver driver_supxevs	   = new GameDriver("19??"	,"supxevs"	,"vsnes.java"	,rom_supxevs,null	,machine_driver_vsnes	,input_ports_vsnes	,init_xevious	,ROT0	,	"Namco?",   "Vs. Super Xevious", GAME_NOT_WORKING )
	public static GameDriver driver_vsfdf	   = new GameDriver("1988?"	,"vsfdf"	,"vsnes.java"	,rom_vsfdf,null	,machine_driver_vsnes	,input_ports_vsfdf	,init_vsfdf	,	,	ROT0, "Konami",   "Vs. Freedom Force", GAME_NOT_WORKING )
