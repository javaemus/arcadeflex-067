...
public class tetrisp2
{
	...
	***************************************************************************/
	...
	static InputPortPtr input_ports_rockn1 = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	// IN0 - $be0002.w
		PORT_BIT(  0x0001, IP_ACTIVE_LOW, IPT_UNKNOWN  );
		PORT_BIT(  0x0002, IP_ACTIVE_LOW, IPT_UNKNOWN  );
		PORT_BIT(  0x0004, IP_ACTIVE_LOW, IPT_JOYSTICK_LEFT  | IPF_PLAYER1 );
	...
	static InputPortPtr input_ports_rocknms = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	// IN0 - $be0002.w
	...
	***************************************************************************/
	...
	static GfxDecodeInfo rocknms_gfxdecodeinfo[] =
	{
		new GfxDecodeInfo( REGION_GFX1, 0, layout_8x8x8,   0x0000, 0x10 ), // [0] Sprites
		new GfxDecodeInfo( REGION_GFX2, 0, layout_16x16x8, 0x1000, 0x10 ), // [1] Background
		new GfxDecodeInfo( REGION_GFX3, 0, layout_16x16x8, 0x2000, 0x10 ), // [2] Rotation
		new GfxDecodeInfo( REGION_GFX4, 0, layout_8x8x8,   0x6000, 0x10 ), // [3] Foreground
		new GfxDecodeInfo( REGION_GFX5, 0, layout_8x8x8,   0x8000, 0x10 ), // [0] Sprites
		new GfxDecodeInfo( REGION_GFX6, 0, layout_16x16x8, 0x9000, 0x10 ), // [1] Background
		new GfxDecodeInfo( REGION_GFX7, 0, layout_16x16x8, 0xa000, 0x10 ), // [2] Rotation
		new GfxDecodeInfo( REGION_GFX8, 0, layout_8x8x8,   0xe000, 0x10 ), // [3] Foreground
		new GfxDecodeInfo( -1 )
	};
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_rockn1 = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_rockn2 = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_rockn3 = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_rockn4 = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_rocknms = new RomLoadPtr(){ public void handler(){ 
	...
	***************************************************************************/
	...
	public static GameDriver driver_rockn1	   = new GameDriver("1999"	,"rockn1"	,"tetrisp2.java"	,rom_rockn1,null	,machine_driver_rockn1	,input_ports_rockn1	,init_rockn1	,ROT270	,	"Jaleco", "Rock'n Tread 1 (Japan)" )
	public static GameDriver driver_rockn2	   = new GameDriver("1999"	,"rockn2"	,"tetrisp2.java"	,rom_rockn2,null	,machine_driver_rockn2	,input_ports_rockn1	,init_rockn2	,ROT270	,	"Jaleco", "Rock'n Tread 2 (Japan)" )
	public static GameDriver driver_rocknms	   = new GameDriver("1999"	,"rocknms"	,"tetrisp2.java"	,rom_rocknms,null	,machine_driver_rocknms	,input_ports_rocknms	,init_rocknms	,ROT270	,	"Jaleco", "Rock'n MegaSession (Japan)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_rockn3	   = new GameDriver("1999"	,"rockn3"	,"tetrisp2.java"	,rom_rockn3,null	,machine_driver_rockn2	,input_ports_rockn1	,init_rockn3	,ROT270	,	"Jaleco", "Rock'n 3 (Japan)" )
	public static GameDriver driver_rockn4	   = new GameDriver("2000"	,"rockn4"	,"tetrisp2.java"	,rom_rockn4,null	,machine_driver_rockn2	,input_ports_rockn1	,init_rockn3	,ROT270	,	"Jaleco (PCCWJ)", "Rock'n 4 (Japan prototype version)" )
}
