...
public class sidearms
{
	...
	public static GameDriver driver_sidearms	   = new GameDriver("1986"	,"sidearms"	,"sidearms.java"	,rom_sidearms,null	,machine_driver_sidearms	,input_ports_sidearms	,init_sidearms	,ROT0	,	"Capcom", "Side Arms - Hyper Dyne (World)", GAME_NO_COCKTAIL|GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_sidearmr	   = new GameDriver("1986"	,"sidearmr"	,"sidearms.java"	,rom_sidearmr,driver_sidearms	,machine_driver_sidearms	,input_ports_sidearms	,init_sidearms	,ROT0	,	"Capcom (Romstar license)", "Side Arms - Hyper Dyne (US)", GAME_NO_COCKTAIL|GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_sidearjp	   = new GameDriver("1986"	,"sidearjp"	,"sidearms.java"	,rom_sidearjp,driver_sidearms	,machine_driver_sidearms	,input_ports_sidearms	,init_sidearms	,ROT0	,	"Capcom", "Side Arms - Hyper Dyne (Japan)", GAME_NO_COCKTAIL|GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_turtship	   = new GameDriver("1988"	,"turtship"	,"sidearms.java"	,rom_turtship,null	,machine_driver_turtship	,input_ports_turtship	,init_turtship	,ROT0	,	"Philko", "Turtle Ship", GAME_NO_COCKTAIL )
	public static GameDriver driver_dyger	   = new GameDriver("1989"	,"dyger"	,"sidearms.java"	,rom_dyger,null	,machine_driver_turtship	,input_ports_dyger	,init_dyger	,ROT270	,	"Philko", "Dyger (Korea set 1)", GAME_NO_COCKTAIL )
	public static GameDriver driver_dygera	   = new GameDriver("1989"	,"dygera"	,"sidearms.java"	,rom_dygera,driver_dyger	,machine_driver_turtship	,input_ports_dyger	,init_dyger	,ROT270	,	"Philko", "Dyger (Korea set 2)", GAME_NO_COCKTAIL )
}
