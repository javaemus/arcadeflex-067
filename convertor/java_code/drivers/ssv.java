...
public class ssv
{
	...
	***************************************************************************/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, layout_16x8x8, 0, 0x8000/64 * 2 ), // Sprites
		new GfxDecodeInfo( -1 )
	};
	...
	***************************************************************************/
	...
	public static GameDriver driver_survarts	   = new GameDriver("1993"	,"survarts"	,"ssv.java"	,rom_survarts,null	,machine_driver_survarts	,input_ports_survarts	,init_survarts	,ROT0	,	"Sammy (American)",   "Survival Arts (USA)",                          GAME_NO_COCKTAIL )
	...
	public static GameDriver driver_janjans1	   = new GameDriver("1996"	,"janjans1"	,"ssv.java"	,rom_janjans1,null	,machine_driver_janjans1	,input_ports_janjans1	,init_janjans1	,ROT0	,	"Visco",              "Lovely Pop Mahjong Jan Jan Shimasyo (Japan)",  GAME_NO_COCKTAIL )
	public static GameDriver driver_stmblade	   = new GameDriver("1996"	,"stmblade"	,"ssv.java"	,rom_stmblade,null	,machine_driver_stmblade	,input_ports_stmblade	,init_stmblade	,ROT270	,	"Visco",              "Storm Blade (US)",                             GAME_IMPERFECT_GRAPHICS | GAME_NO_COCKTAIL )
	...
	public static GameDriver driver_twineag2	   = new GameDriver("1994"	,"twineag2"	,"ssv.java"	,rom_twineag2,null	,machine_driver_twineag2	,input_ports_twineag2	,init_twineag2	,ROT270	,	"Seta",               "Twin Eagle II - The Rescue Mission",           GAME_NO_COCKTAIL | GAME_NOT_WORKING )
	public static GameDriver driver_eaglshot	   = new GameDriver("1994"	,"eaglshot"	,"ssv.java"	,rom_eaglshot,null	,machine_driver_survarts	,input_ports_survarts	,init_survarts	,ROT0	,	"Sammy",   			  "Eagle Shot Golf",                              GAME_NO_COCKTAIL | GAME_NOT_WORKING)
	public static GameDriver driver_eaglshta	   = new GameDriver("1994"	,"eaglshta"	,"ssv.java"	,rom_eaglshta,driver_eaglshot	,machine_driver_survarts	,input_ports_survarts	,init_survarts	,ROT0	,	"Sammy",   			  "Eagle Shot Golf (alt)",                        GAME_NO_COCKTAIL | GAME_NOT_WORKING)
}
