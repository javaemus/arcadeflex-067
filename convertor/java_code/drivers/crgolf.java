...
public class crgolf
{
	...
	public static GameDriver driver_crgolfb	   = new GameDriver("1984"	,"crgolfb"	,"crgolf.java"	,rom_crgolfb,driver_crgolf	,machine_driver_crgolf	,input_ports_crgolf	,null	,ROT0	,	"Nasco Japan", "Champion Golf (bootleg)" )
}
