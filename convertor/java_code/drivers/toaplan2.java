...
public class toaplan2
{
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_bbakrada = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x200000, REGION_CPU1, 0 );		/* Main 68k code */
	...
	public static GameDriver driver_snowbro2	   = new GameDriver("1994"	,"snowbro2"	,"toaplan2.java"	,rom_snowbro2,null	,machine_driver_snowbro2	,input_ports_snowbro2	,init_T2_noZ80	,ROT0	,	"[Toaplan] Hanafram", "Snow Bros. 2 / Otenki Paradise" )
	...
	public static GameDriver driver_shippumd	   = new GameDriver("1994"	,"shippumd"	,"toaplan2.java"	,rom_shippumd,null	,machine_driver_shippumd	,input_ports_shippumd	,init_T2_Z80	,ROT270	,	"Raizing/8ing", "Shippu Mahou Daisakusen (Japan)" )
	public static GameDriver driver_battleg	   = new GameDriver("1996"	,"battleg"	,"toaplan2.java"	,rom_battleg,null	,machine_driver_battleg	,input_ports_battleg	,init_battleg	,ROT270	,	"Raizing/8ing", "Battle Garegga - Type 2 (Denmark / China)" )
	public static GameDriver driver_battlega	   = new GameDriver("1996"	,"battlega"	,"toaplan2.java"	,rom_battlega,driver_battleg	,machine_driver_battleg	,input_ports_battlega	,init_battleg	,ROT270	,	"Raizing/8ing", "Battle Garegga (Europe / USA / Japan / Asia)" )
	...
	public static GameDriver driver_bbakraid	   = new GameDriver("1999"	,"bbakraid"	,"toaplan2.java"	,rom_bbakraid,null	,machine_driver_bbakraid	,input_ports_bbakraid	,init_T2_Z80	,ROT270	,	"8ing", "Battle Bakraid - unlimited version (Japan)")
	public static GameDriver driver_bbakrada	   = new GameDriver("1999"	,"bbakrada"	,"toaplan2.java"	,rom_bbakrada,driver_bbakraid	,machine_driver_bbakraid	,input_ports_bbakraid	,init_T2_Z80	,ROT270	,	"8ing", "Battle Bakraid (Japan)")
}
