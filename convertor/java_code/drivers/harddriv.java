...
public class harddriv
{
	...
	*/
	...
	public static GameDriver driver_harddriv	   = new GameDriver("1988"	,"harddriv"	,"harddriv.java"	,rom_harddriv,null	,machine_driver_harddriv	,input_ports_harddriv	,init_harddriv	,ROT0	,	"Atari Games", "Hard Drivin' (cockpit)" )
	public static GameDriver driver_harddrvc	   = new GameDriver("1990"	,"harddrvc"	,"harddriv.java"	,rom_harddrvc,driver_harddriv	,machine_driver_harddrvc	,input_ports_racedrvc	,init_harddrvc	,ROT0	,	"Atari Games", "Hard Drivin' (compact)" )
	...
	public static GameDriver driver_stunrnp	   = new GameDriver("1989"	,"stunrnp"	,"harddriv.java"	,rom_stunrnp,driver_stunrun	,machine_driver_stunrun	,input_ports_stunrun	,init_stunrun	,ROT0	,	"Atari Games", "S.T.U.N. Runner (upright prototype)" )
	public static GameDriver driver_racedriv	   = new GameDriver("1990"	,"racedriv"	,"harddriv.java"	,rom_racedriv,null	,machine_driver_racedriv	,input_ports_racedriv	,init_racedriv	,ROT0	,	"Atari Games", "Race Drivin' (cockpit)" )
	...
	public static GameDriver driver_racedrvc	   = new GameDriver("1990"	,"racedrvc"	,"harddriv.java"	,rom_racedrvc,driver_racedriv	,machine_driver_racedrvc	,input_ports_racedrvc	,init_racedrvc	,ROT0	,	"Atari Games", "Race Drivin' (compact)" )
	public static GameDriver driver_steeltal	   = new GameDriver("1991"	,"steeltal"	,"harddriv.java"	,rom_steeltal,null	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0	,	"Atari Games", "Steel Talons" )
	public static GameDriver driver_steeltap	   = new GameDriver("1991"	,"steeltap"	,"harddriv.java"	,rom_steeltap,driver_steeltal	,machine_driver_steeltal	,input_ports_steeltal	,init_steeltal	,ROT0	,	"Atari Games", "Steel Talons (prototype)", GAME_NOT_WORKING )
