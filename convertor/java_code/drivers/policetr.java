...
public class policetr
{
	...
	public static GameDriver driver_policetr	   = new GameDriver("1996"	,"policetr"	,"policetr.java"	,rom_policetr,null	,machine_driver_policetr	,input_ports_policetr	,init_policetr	,ROT0	,	"P&P Marketing", "Police Trainer (Rev 1.5)" )
