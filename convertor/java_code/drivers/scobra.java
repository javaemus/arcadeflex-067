...
public class scobra
{
	...
	public static Memory_ReadAddress mimonksc_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
	...
	public static Memory_WriteAddress mimonksc_writemem[]={
		new Memory_WriteAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_WRITE | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_WriteAddress( 0x0000, 0x3fff, MWA_ROM ),
		new Memory_WriteAddress( 0x8000, 0x87ff, MWA_RAM ),
		new Memory_WriteAddress( 0x8800, 0x8bff, galaxian_videoram_w, galaxian_videoram ),
	...
	static InputPortPtr input_ports_mimonksc = new InputPortPtr(){ public void handler() { 
		PORT_START(); 	/* IN0 */
	...
	***************************************************************************/
	...
	static RomLoadPtr rom_mimonksc = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x10000, REGION_CPU1, 0 );/* 64k for code */
	...
	public static GameDriver driver_mimonksc	   = new GameDriver("198?"	,"mimonksc"	,"scobra.java"	,rom_mimonksc,driver_mimonkey	,machine_driver_mimonksc	,input_ports_mimonksc	,init_mimonksc	,ROT90	,	"bootleg", "Mighty Monkey (bootleg on Super Cobra hardware)", GAME_NOT_WORKING )
}
