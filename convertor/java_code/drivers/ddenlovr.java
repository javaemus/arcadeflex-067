...
public class ddenlovr
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_mmpanic	   = new GameDriver("1992"	,"mmpanic"	,"ddenlovr.java"	,rom_mmpanic,null	,machine_driver_quizchq	,input_ports_rongrong	,null	,ROT0	,	"Nakanihon (Taito license)", "Monkey Mole Panic", GAME_NOT_WORKING | GAME_NO_COCKTAIL )
	public static GameDriver driver_quizchq	   = new GameDriver("1993"	,"quizchq"	,"ddenlovr.java"	,rom_quizchq,null	,machine_driver_quizchq	,input_ports_rongrong	,null	,ROT0	,	"Nakanihon", "Quiz Channel Question (Ver 1.00) (Japan)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND | GAME_NO_COCKTAIL )
	public static GameDriver driver_quizchql	   = new GameDriver("1993"	,"quizchql"	,"ddenlovr.java"	,rom_quizchql,driver_quizchq	,machine_driver_quizchq	,input_ports_rongrong	,null	,ROT0	,	"[Nakanihon] (Laxan license)", "Quiz Channel Question (Ver 1.23) (Taiwan?)", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND | GAME_NO_COCKTAIL )
	public static GameDriver driver_quiz365	   = new GameDriver("1994"	,"quiz365"	,"ddenlovr.java"	,rom_quiz365,null	,machine_driver_quiz365	,input_ports_quiz365	,null	,ROT0	,	"Nakanihon", "Quiz 365 (Hong Kong & Taiwan)", GAME_IMPERFECT_GRAPHICS | GAME_NO_COCKTAIL )
	...
	public static GameDriver driver_ddenlovr	   = new GameDriver("1996"	,"ddenlovr"	,"ddenlovr.java"	,rom_ddenlovr,null	,machine_driver_ddenlovr	,input_ports_ddenlovr	,null	,ROT0	,	"Dynax",     "Don Den Lover Vol. 1 (Hong Kong)", GAME_IMPERFECT_COLORS | GAME_NO_COCKTAIL )
