...
public class tehkanwc
{
	...
	public static Memory_WriteAddress writemem[]={
		...
		new Memory_WriteAddress( 0xf860, 0xf860, flip_screen_x_w ),		/* Check if it's really X */
		new Memory_WriteAddress( 0xf870, 0xf870, flip_screen_y_w ),		/* Check if it's really Y */
	...
	***************************************************************************/
	...
	public static GameDriver driver_teedoff	   = new GameDriver("1986"	,"teedoff"	,"tehkanwc.java"	,rom_teedoff,null	,machine_driver_teedoff	,input_ports_teedoff	,init_teedoff	,ROT90	,	"Tecmo", "Tee'd Off (Japan)", GAME_NO_COCKTAIL )
}
