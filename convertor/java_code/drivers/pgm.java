...
public class pgm
{
	...
	*/
	...
	public static GameDriver driver_orlegnde	   = new GameDriver("1997"	,"orlegnde"	,"pgm.java"	,rom_orlegnde,driver_orlegend	,machine_driver_pgm	,input_ports_pgm	,init_orlegnde	,ROT0	,	"IGS", "Oriental Legend / Xi Yo Gi Shi Re Zuang (ver. 112)", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND  )
	public static GameDriver driver_orlegndc	   = new GameDriver("1997"	,"orlegndc"	,"pgm.java"	,rom_orlegndc,driver_orlegend	,machine_driver_pgm	,input_ports_pgm	,init_orlegnde	,ROT0	,	"IGS", "Oriental Legend / Xi Yo Gi Shi Re Zuang (ver. 112, Chinese Board)", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND  )
	public static GameDriver driver_dragwld2	   = new GameDriver("1997"	,"dragwld2"	,"pgm.java"	,rom_dragwld2,driver_pgm	,machine_driver_pgm	,input_ports_pgm	,init_dragwld2	,ROT0	,	"IGS", "Dragon World II (ver. 100C, China)", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
