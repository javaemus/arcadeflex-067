...
public class taitoair
{
	...
	*************************************************************/
	...
	public static GameDriver driver_topland	   = new GameDriver("1988"	,"topland"	,"taitoair.java"	,rom_topland,null	,machine_driver_airsys	,input_ports_topland	,init_taitoair	,ROT0	,	"Taito Corporation Japan", "Top Landing (World)" )
	public static GameDriver driver_ainferno	   = new GameDriver("1990"	,"ainferno"	,"taitoair.java"	,rom_ainferno,null	,machine_driver_airsys	,input_ports_ainferno	,init_taitoair	,ROT0	,	"Taito America Corporation", "Air Inferno (US)" )
}
