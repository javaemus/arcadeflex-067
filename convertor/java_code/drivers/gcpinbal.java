...
public class gcpinbal
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_gcpinbal	   = new GameDriver("1994"	,"gcpinbal"	,"gcpinbal.java"	,rom_gcpinbal,null	,machine_driver_gcpinbal	,input_ports_gcpinbal	,null	,ROT270	,	"Excellent System", "Grand Cross", GAME_NO_SOUND | GAME_NO_COCKTAIL )
