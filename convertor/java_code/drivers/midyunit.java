...
public class midyunit
{
	...
	*/
	...
	public static GameDriver driver_mkprot9	   = new GameDriver("1992"	,"mkprot9"	,"midyunit.java"	,rom_mkprot9,driver_mk	,machine_driver_mk	,input_ports_mkla1	,init_mkprot9	,ROT0	,	"Midway",   "Mortal Kombat (prototype, rev 9.0 07/28/92)" )
	public static GameDriver driver_mkla1	   = new GameDriver("1992"	,"mkla1"	,"midyunit.java"	,rom_mkla1,driver_mk	,machine_driver_mk	,input_ports_mkla1	,init_mkla1	,ROT0	,	"Midway",   "Mortal Kombat (rev 1.0 08/08/92)" )
	public static GameDriver driver_mkla2	   = new GameDriver("1992"	,"mkla2"	,"midyunit.java"	,rom_mkla2,driver_mk	,machine_driver_mk	,input_ports_mkla1	,init_mkla2	,ROT0	,	"Midway",   "Mortal Kombat (rev 2.0 08/18/92)" )
	public static GameDriver driver_mkla3	   = new GameDriver("1992"	,"mkla3"	,"midyunit.java"	,rom_mkla3,driver_mk	,machine_driver_mk	,input_ports_mkla1	,init_mkla3	,ROT0	,	"Midway",   "Mortal Kombat (rev 3.0 08/31/92)" )
	public static GameDriver driver_mkla4	   = new GameDriver("1992"	,"mkla4"	,"midyunit.java"	,rom_mkla4,driver_mk	,machine_driver_mk	,input_ports_mkla1	,init_mkla4	,ROT0	,	"Midway",   "Mortal Kombat (rev 4.0 09/28/92)" )
