...
public class ms32
{
	...
	*/
	...
	/*
	public static Memory_ReadAddress ms32_sound_readmem[]={
		new Memory_ReadAddress(MEMPORT_MARKER, MEMPORT_DIRECTION_READ | MEMPORT_TYPE_MEM | MEMPORT_WIDTH_8),
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	
	public static Memory_WriteAddress ms32_sound_writemem[]={
	...
	*/
	...
	public static GameDriver driver_hayaosi1	   = new GameDriver("1994"	,"hayaosi1"	,"ms32.java"	,rom_hayaosi1,null	,machine_driver_ms32	,input_ports_hayaosi1	,init_ss92046_01	,ROT0	,	"Jaleco", "Hayaoshi Quiz Ouza Ketteisen", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_bbbxing	   = new GameDriver("1994"	,"bbbxing"	,"ms32.java"	,rom_bbbxing,null	,machine_driver_ms32	,input_ports_bbbxing	,init_ss92046_01	,ROT0	,	"Jaleco", "Best Bout Boxing", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_desertwr	   = new GameDriver("1995"	,"desertwr"	,"ms32.java"	,rom_desertwr,null	,machine_driver_ms32	,input_ports_desertwr	,init_ss91022_10	,ROT270	,	"Jaleco", "Desert War", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND  )
	public static GameDriver driver_gametngk	   = new GameDriver("1995"	,"gametngk"	,"ms32.java"	,rom_gametngk,null	,machine_driver_ms32	,input_ports_gametngk	,init_ss91022_10	,ROT270	,	"Jaleco", "The Game Paradise - Master of Shooting! / Game Tengoku - The Game Paradise", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_tetrisp	   = new GameDriver("1995"	,"tetrisp"	,"ms32.java"	,rom_tetrisp,null	,machine_driver_ms32	,input_ports_tetrisp	,init_ss92046_01	,ROT0	,	"Jaleco / BPS", "Tetris Plus", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_p47aces	   = new GameDriver("1995"	,"p47aces"	,"ms32.java"	,rom_p47aces,null	,machine_driver_ms32	,input_ports_p47aces	,init_ss92048_01	,ROT0	,	"Jaleco", "P-47 Aces", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_gratia	   = new GameDriver("1996"	,"gratia"	,"ms32.java"	,rom_gratia,null	,machine_driver_ms32	,input_ports_gratia	,init_ss92047_01	,ROT0	,	"Jaleco", "Gratia - Second Earth (set 1)", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_gratiaa	   = new GameDriver("1996"	,"gratiaa"	,"ms32.java"	,rom_gratiaa,driver_gratia	,machine_driver_ms32	,input_ports_gratia	,init_ss91022_10	,ROT0	,	"Jaleco", "Gratia - Second Earth (set 2)", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_kirarast	   = new GameDriver("1996"	,"kirarast"	,"ms32.java"	,rom_kirarast,null	,machine_driver_ms32	,input_ports_kirarast	,init_kirarast	,ROT0	,	"Jaleco", "Ryuusei Janshi Kirara Star", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_tp2m32	   = new GameDriver("1997"	,"tp2m32"	,"ms32.java"	,rom_tp2m32,driver_tetrisp2	,machine_driver_ms32	,input_ports_ms32	,init_tp2m32	,ROT0	,	"Jaleco", "Tetris Plus 2 (MegaSystem 32 Version)", GAME_NOT_WORKING | GAME_NO_SOUND )
	
	/* these boot and show something */
	public static GameDriver driver_f1superb	   = new GameDriver("1994"	,"f1superb"	,"ms32.java"	,rom_f1superb,null	,machine_driver_ms32	,input_ports_f1superb	,init_ss92046_01	,ROT0	,	"Jaleco", "F1 Super Battle", GAME_NOT_WORKING | GAME_NO_SOUND )
}
