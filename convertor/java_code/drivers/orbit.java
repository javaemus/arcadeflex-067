...
public class orbit
{
	...
	public static GameDriver driver_orbit	   = new GameDriver("1978"	,"orbit"	,"orbit.java"	,rom_orbit,null	,machine_driver_orbit	,input_ports_orbit	,null	,0	,	"Atari", "Orbit", GAME_NO_SOUND )
}
