...
public class konamigx
{
	...
	*/
	...
	public static GameDriver driver_racinfrc	   = new GameDriver("1994"	,"racinfrc"	,"konamigx.java"	,rom_racinfrc,driver_konamigx	,machine_driver_gxtype1	,input_ports_racinfrc	,init_konamigx	,ROT0	,	"Konami", "Racin' Force (version UAB)", GAME_NOT_WORKING )
	...
	public static GameDriver driver_gokuparo	   = new GameDriver("1994"	,"gokuparo"	,"konamigx.java"	,rom_gokuparo,driver_konamigx	,machine_driver_konamigx	,input_ports_gokuparo	,init_gokuparo	,ROT0	,	"Konami", "Gokujyou Parodius (Ver JAD)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_puzldama	   = new GameDriver("1994"	,"puzldama"	,"konamigx.java"	,rom_puzldama,driver_konamigx	,machine_driver_puzzle	,input_ports_puzldama	,init_konamigx	,ROT0	,	"Konami", "Taisen Puzzle-dama (Ver JAA)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_sexyparo	   = new GameDriver("1996"	,"sexyparo"	,"konamigx.java"	,rom_sexyparo,driver_konamigx	,machine_driver_konamigx	,input_ports_gokuparo	,init_sexyparo	,ROT0	,	"Konami", "Sexy Parodius (Ver JAA)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_daiskiss	   = new GameDriver("1996"	,"daiskiss"	,"konamigx.java"	,rom_daiskiss,driver_konamigx	,machine_driver_daiskiss	,input_ports_gokuparo	,init_tbyahhoo	,ROT0	,	"Konami", "Daisu-Kiss (Ver JAA)", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_tokkae	   = new GameDriver("1996"	,"tokkae"	,"konamigx.java"	,rom_tokkae,driver_konamigx	,machine_driver_tokkae	,input_ports_puzldama	,init_konamigx	,ROT0	,	"Konami", "Tokkae Puzzle-dama (Ver JAA)", GAME_IMPERFECT_GRAPHICS )
	
	/* these games work and are playable but have major gfx problems */
	public static GameDriver driver_tbyahhoo	   = new GameDriver("1995"	,"tbyahhoo"	,"konamigx.java"	,rom_tbyahhoo,driver_konamigx	,machine_driver_tbyahhoo	,input_ports_gokuparo	,init_tbyahhoo	,ROT0	,	"Konami", "Twin Bee Yahhoo! (Ver JAA)", GAME_IMPERFECT_GRAPHICS )
	
	/* these games run but have missing sprites due to protection */
	public static GameDriver driver_dragoonj	   = new GameDriver("1995"	,"dragoonj"	,"konamigx.java"	,rom_dragoonj,driver_konamigx	,machine_driver_dragoonj	,input_ports_puzldama	,init_konamigx	,ROT0	,	"Konami", "Dragoon Might (Ver JAA)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_tkmmpzdm	   = new GameDriver("1995"	,"tkmmpzdm"	,"konamigx.java"	,rom_tkmmpzdm,driver_konamigx	,machine_driver_konamigx_6bpp	,input_ports_puzldama	,init_konamigx	,ROT0	,	"Konami", "Tokimeki Memorial Taisen Puzzle-dama (version JAB)", GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_salmndr2	   = new GameDriver("1996"	,"salmndr2"	,"konamigx.java"	,rom_salmndr2,driver_konamigx	,machine_driver_konamigx_6bpp_2	,input_ports_gokuparo	,init_sal2	,ROT0	,	"Konami", "Salamander 2", GAME_UNEMULATED_PROTECTION )
	
	/* these games are unplayable due to protection */
	public static GameDriver driver_fantjour	   = new GameDriver("1994"	,"fantjour"	,"konamigx.java"	,rom_fantjour,driver_gokuparo	,machine_driver_konamigx	,input_ports_konamigx	,init_gokuparo	,ROT0	,	"Konami", "Fantastic Journey", GAME_NOT_WORKING|GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_winspike	   = new GameDriver("1997"	,"winspike"	,"konamigx.java"	,rom_winspike,driver_konamigx	,machine_driver_konamigx_6bpp	,input_ports_konamigx	,init_konamigx	,ROT0	,	"Konami", "Winning Spike (Ver JAA)", GAME_NOT_WORKING|GAME_UNEMULATED_PROTECTION )
	...
	public static GameDriver driver_vsnetscr	   = new GameDriver("1996"	,"vsnetscr"	,"konamigx.java"	,rom_vsnetscr,driver_konamigx	,machine_driver_gxtype3	,input_ports_type3	,init_konamigx	,ROT0	,	"Konami", "Versus Net Soccer (Ver UAB)", GAME_NOT_WORKING )
	...
	/* Type 4: dual monitor output and 53936 on the ROM board.  Doesn't use the GX's own
	   ...
	   separate driver. */
	public static GameDriver driver_rungun2	   = new GameDriver("1996"	,"rungun2"	,"konamigx.java"	,rom_rungun2,driver_konamigx	,machine_driver_gxtype4	,input_ports_type3	,init_sexyparo	,ROT0	,	"Konami", "Run and Gun 2 (Ver UAA)", GAME_NOT_WORKING )
}
