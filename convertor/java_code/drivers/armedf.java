...
public class armedf
{
	...
	*****************/
	...
	public static GameDriver driver_legion	   = new GameDriver("1986"	,"legion"	,"armedf.java"	,rom_legion,null	,machine_driver_cclimbr2	,input_ports_legion	,init_legion	,ROT270	,	"Nichibutsu", "Legion (ver 2.03)", GAME_NO_COCKTAIL | GAME_IMPERFECT_GRAPHICS | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_legiono	   = new GameDriver("1986"	,"legiono"	,"armedf.java"	,rom_legiono,driver_legion	,machine_driver_cclimbr2	,input_ports_legion	,init_legiono	,ROT270	,	"Nichibutsu", "Legion (ver 1.05)", GAME_NO_COCKTAIL | GAME_IMPERFECT_GRAPHICS | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_terraf	   = new GameDriver("1987"	,"terraf"	,"armedf.java"	,rom_terraf,null	,machine_driver_terraf	,input_ports_terraf	,init_terraf	,ROT0	,	"Nichibutsu", "Terra Force", GAME_NO_COCKTAIL | GAME_IMPERFECT_GRAPHICS | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_terrafu	   = new GameDriver("1987"	,"terrafu"	,"armedf.java"	,rom_terrafu,driver_terraf	,machine_driver_terraf	,input_ports_terraf	,init_terraf	,ROT0	,	"Nichibutsu USA", "Terra Force (US)", GAME_NO_COCKTAIL | GAME_IMPERFECT_GRAPHICS | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_kodure	   = new GameDriver("1987"	,"kodure"	,"armedf.java"	,rom_kodure,null	,machine_driver_kodure	,input_ports_kodure	,init_kodure	,ROT0	,	"Nichibutsu", "Kodure Ookami (Japan)", GAME_NO_COCKTAIL | GAME_IMPERFECT_GRAPHICS | GAME_UNEMULATED_PROTECTION )
	public static GameDriver driver_cclimbr2	   = new GameDriver("1988"	,"cclimbr2"	,"armedf.java"	,rom_cclimbr2,null	,machine_driver_cclimbr2	,input_ports_cclimbr2	,init_cclimbr2	,ROT0	,	"Nichibutsu", "Crazy Climber 2 (Japan)", GAME_NO_COCKTAIL )
	public static GameDriver driver_armedf	   = new GameDriver("1988"	,"armedf"	,"armedf.java"	,rom_armedf,null	,machine_driver_armedf	,input_ports_armedf	,init_armedf	,ROT270	,	"Nichibutsu", "Armed Formation", GAME_NO_COCKTAIL )
}
