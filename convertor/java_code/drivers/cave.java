...
public class cave
{
	...
	***************************************************************************/
	...
	{
	//    REGION_GFX1										// Sprites
		new GfxDecodeInfo( REGION_GFX2, 0, layout_8x8x4,	0x1800, 0x40 ), // [0] Layer 0
		new GfxDecodeInfo( REGION_GFX3, 0, layout_8x8x4,	0x0800, 0x40 ), // [1] Layer 1
		new GfxDecodeInfo( REGION_GFX4, 0, layout_8x8x4,	0x1000, 0x40 ), // [2] Layer 2
		new GfxDecodeInfo( REGION_GFX5, 0, layout_8x8x4,	0x2000, 0x40 ), // [3] Layer 3
		new GfxDecodeInfo( -1 )
	};
	...
	***************************************************************************/
	...
	public static GameDriver driver_mazinger	   = new GameDriver("1994"	,"mazinger"	,"cave.java"	,rom_mazinger,null	,machine_driver_mazinger	,input_ports_cave	,init_mazinger	,ROT90	,	"Banpresto/Dynamic Pl. Toei Animation", "Mazinger Z"                 )
	...
	public static GameDriver driver_sailormn	   = new GameDriver("1995"	,"sailormn"	,"cave.java"	,rom_sailormn,null	,machine_driver_sailormn	,input_ports_cave	,init_sailormn	,ROT0	,	"Banpresto",                            "Pretty Soldier Sailor Moon (95/03/22B)" )
	public static GameDriver driver_sailormo	   = new GameDriver("1995"	,"sailormo"	,"cave.java"	,rom_sailormo,driver_sailormn	,machine_driver_sailormn	,input_ports_cave	,init_sailormn	,ROT0	,	"Banpresto",                            "Pretty Soldier Sailor Moon (95/03/22)" )
	public static GameDriver driver_agallet	   = new GameDriver("1996"	,"agallet"	,"cave.java"	,rom_agallet,null	,machine_driver_sailormn	,input_ports_cave	,init_agallet	,ROT270	,	"Banpresto / Gazelle",                  "Air Gallet (Taiwan)"        )
	...
	public static GameDriver driver_pwrinst2	   = new GameDriver("1994"	,"pwrinst2"	,"cave.java"	,rom_pwrinst2,null	,machine_driver_pwrinst2	,input_ports_metmqstr	,init_pwrinst2	,ROT0	,	"Atlus/Cave",                           "Power Instinct 2 (USA)", GAME_NOT_WORKING )
}
