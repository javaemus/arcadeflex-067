...
public class cojag
{
	...
	*/
	...
	static RomLoadPtr rom_area51 = new RomLoadPtr(){ public void handler(){ 
	...
	static RomLoadPtr rom_maxforce = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x800000, REGION_CPU1, 0 );	/* 4MB for RAM at 0 */
	...
	public static GameDriver driver_maxforce	   = new GameDriver("1996"	,"maxforce"	,"cojag.java"	,rom_maxforce,null	,machine_driver_r3knarrow	,input_ports_area51	,init_maxforce	,ROT0	,	"Atari Games", "Maximum Force" )
