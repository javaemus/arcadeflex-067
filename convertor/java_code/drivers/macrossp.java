...
public class macrossp
{
	...
	*/
	...
	public static GameDriver driver_macrossp	   = new GameDriver("1996"	,"macrossp"	,"macrossp.java"	,rom_macrossp,null	,machine_driver_macrossp	,input_ports_macrossp	,init_macrossp	,ROT270	,	"Banpresto", "Macross Plus", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
	public static GameDriver driver_quizmoon	   = new GameDriver("1997"	,"quizmoon"	,"macrossp.java"	,rom_quizmoon,null	,machine_driver_quizmoon	,input_ports_macrossp	,null	,ROT0	,	"Banpresto", "Quiz Bisyoujo Senshi Sailor Moon - Chiryoku Tairyoku Toki no Un", GAME_IMPERFECT_GRAPHICS | GAME_NO_SOUND )
}
