...
public class stv
{
	...
	*/
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, tiles8x8x4_layout,   0x00, 0x100  ),
		new GfxDecodeInfo( REGION_GFX1, 0, tiles8x8x8_layout,   0x00, 0x100  ),
	...
	*/
	...
	public static GameDriver driver_stvbios	   = new GameDriver("1996"	,"stvbios"	,"stv.java"	,rom_stvbios,null	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "ST-V Bios", NOT_A_DRIVER )
	
	public static GameDriver driver_astrass	   = new GameDriver("199?"	,"astrass"	,"stv.java"	,rom_astrass,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Astro SuperStars", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_bakubaku	   = new GameDriver("199?"	,"bakubaku"	,"stv.java"	,rom_bakubaku,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Baku Baku Animal", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_colmns97	   = new GameDriver("1996"	,"colmns97"	,"stv.java"	,rom_colmns97,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Columns 97", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_cotton2	   = new GameDriver("199?"	,"cotton2"	,"stv.java"	,rom_cotton2,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Cotton 2", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_cottonbm	   = new GameDriver("199?"	,"cottonbm"	,"stv.java"	,rom_cottonbm,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Cotton Boomerang", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_decathlt	   = new GameDriver("199?"	,"decathlt"	,"stv.java"	,rom_decathlt,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Decathlete", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_diehard	   = new GameDriver("199?"	,"diehard"	,"stv.java"	,rom_diehard,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Die Hard Arcade (US)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_dnmtdeka	   = new GameDriver("199?"	,"dnmtdeka"	,"stv.java"	,rom_dnmtdeka,driver_diehard	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Dynamite Deka (Japan)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_ejihon	   = new GameDriver("199?"	,"ejihon"	,"stv.java"	,rom_ejihon,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Ejihon", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_elandore	   = new GameDriver("199?"	,"elandore"	,"stv.java"	,rom_elandore,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Elandoree", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_ffreveng	   = new GameDriver("199?"	,"ffreveng"	,"stv.java"	,rom_ffreveng,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Final Fight Revenge", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_fhboxers	   = new GameDriver("199?"	,"fhboxers"	,"stv.java"	,rom_fhboxers,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Funky Head Boxers", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_findlove	   = new GameDriver("199?"	,"findlove"	,"stv.java"	,rom_findlove,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Find Love", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_finlarch	   = new GameDriver("199?"	,"finlarch"	,"stv.java"	,rom_finlarch,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Final Arch", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_gaxeduel	   = new GameDriver("199?"	,"gaxeduel"	,"stv.java"	,rom_gaxeduel,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Golden Axe - The Duel", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_grdforce	   = new GameDriver("199?"	,"grdforce"	,"stv.java"	,rom_grdforce,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Guardian Force", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_groovef	   = new GameDriver("199?"	,"groovef"	,"stv.java"	,rom_groovef,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Power Instinct 3 - Groove On Fight", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_hanagumi	   = new GameDriver("199?"	,"hanagumi"	,"stv.java"	,rom_hanagumi,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Hanagumi Taisen Columns - Sakura Wars", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_introdon	   = new GameDriver("199?"	,"introdon"	,"stv.java"	,rom_introdon,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Intro Don Don", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_kiwames	   = new GameDriver("199?"	,"kiwames"	,"stv.java"	,rom_kiwames,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Pro Mahjong Kiwame S", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_maruchan	   = new GameDriver("199?"	,"maruchan"	,"stv.java"	,rom_maruchan,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Maru-Chan de Goo!", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_myfairld	   = new GameDriver("199?"	,"myfairld"	,"stv.java"	,rom_myfairld,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Virtual Mahjong 2 - My Fair Lady", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_othellos	   = new GameDriver("199?"	,"othellos"	,"stv.java"	,rom_othellos,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Othello Shiyouyo", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_pblbeach	   = new GameDriver("199?"	,"pblbeach"	,"stv.java"	,rom_pblbeach,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Pebble Beach - The Great Shot", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_prikura	   = new GameDriver("199?"	,"prikura"	,"stv.java"	,rom_prikura,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Purikura Sakusen", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_puyosun	   = new GameDriver("199?"	,"puyosun"	,"stv.java"	,rom_puyosun,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Puyo Puyo Sun", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_rsgun	   = new GameDriver("199?"	,"rsgun"	,"stv.java"	,rom_rsgun,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Radiant Silvergun", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_sandor	   = new GameDriver("199?"	,"sandor"	,"stv.java"	,rom_sandor,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Sando-R", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_sassisu	   = new GameDriver("199?"	,"sassisu"	,"stv.java"	,rom_sassisu,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Taisen Tanto-R 'Sasshissu!'", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_seabass	   = new GameDriver("199?"	,"seabass"	,"stv.java"	,rom_seabass,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Sea Bass Fishing", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_shanhigw	   = new GameDriver("199?"	,"shanhigw"	,"stv.java"	,rom_shanhigw,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Shanghai - The Great Wall", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_shienryu	   = new GameDriver("199?"	,"shienryu"	,"stv.java"	,rom_shienryu,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Shienryu", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_sleague	   = new GameDriver("199?"	,"sleague"	,"stv.java"	,rom_sleague,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Super Major League (US)", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_sokyugrt	   = new GameDriver("199?"	,"sokyugrt"	,"stv.java"	,rom_sokyugrt,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Soukyugurentai/Terra Diver", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_sss	   = new GameDriver("199?"	,"sss"	,"stv.java"	,rom_sss,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Steep Slope Sliders", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_suikoenb	   = new GameDriver("199?"	,"suikoenb"	,"stv.java"	,rom_suikoenb,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Suikoenbu", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_twcup98	   = new GameDriver("199?"	,"twcup98"	,"stv.java"	,rom_twcup98,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Tecmo World Cup '98", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_vfkids	   = new GameDriver("199?"	,"vfkids"	,"stv.java"	,rom_vfkids,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Virtua Fighter Kids", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_vfremix	   = new GameDriver("199?"	,"vfremix"	,"stv.java"	,rom_vfremix,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Virtua Fighter Remix", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_vmahjong	   = new GameDriver("199?"	,"vmahjong"	,"stv.java"	,rom_vmahjong,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Virtual Mahjong", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_winterht	   = new GameDriver("1997"	,"winterht"	,"stv.java"	,rom_winterht,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Winter Heat", GAME_NO_SOUND | GAME_NOT_WORKING )
	public static GameDriver driver_znpwfv	   = new GameDriver("1997"	,"znpwfv"	,"stv.java"	,rom_znpwfv,driver_stvbios	,machine_driver_stv	,input_ports_stv	,init_stv	,ROT0	,	"Sega", "Zen Nippon Pro-Wrestling Featuring Virtua", GAME_NO_SOUND | GAME_NOT_WORKING )
