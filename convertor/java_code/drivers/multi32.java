...
public class multi32
{
	...
	public static ReadHandlerPtr sys32_shared_snd_long_r  = new ReadHandlerPtr() { public int handler(int offset)
	{
	...
	public static WriteHandlerPtr sys32_shared_snd_long_w = new WriteHandlerPtr() {public void handler(int offset, int data)
	{
		data8_t *RAM = (data8_t *)system32_shared_ram_long;
	...
	public static GameDriver driver_harddunk	   = new GameDriver("1994"	,"harddunk"	,"multi32.java"	,rom_harddunk,null	,machine_driver_multi32	,input_ports_harddunk	,init_harddunk	,ROT0	,	"Sega", "Hard Dunk (Japan)", GAME_IMPERFECT_GRAPHICS )
