...
public class spbactn
{
	...
	{
		new GfxDecodeInfo( REGION_GFX1, 0, fgtilelayout,   0xa00, 16  ),
		new GfxDecodeInfo( REGION_GFX2, 0, bgtilelayout,   0xb00, 16  ),
		new GfxDecodeInfo( REGION_GFX3, 0, spritelayout,   0x800, 16  ),
	...
	public static GameDriver driver_spbactn	   = new GameDriver("1991"	,"spbactn"	,"spbactn.java"	,rom_spbactn,null	,machine_driver_spbactn	,input_ports_spbactn	,null	,ROT90	,	"Tecmo", "Super Pinball Action (Japan)", GAME_IMPERFECT_GRAPHICS )
}
