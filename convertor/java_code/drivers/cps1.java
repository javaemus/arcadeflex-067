...
public class cps1
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_kodu	   = new GameDriver("1991"	,"kodu"	,"cps1.java"	,rom_kodu,driver_kod	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	"Capcom", "The King of Dragons (US 910910)" )
	public static GameDriver driver_kodj	   = new GameDriver("1991"	,"kodj"	,"cps1.java"	,rom_kodj,driver_kod	,machine_driver_cps1	,input_ports_kod	,init_cps1	,ROT0	,	"Capcom", "The King of Dragons (Japan 910805)" )
	...
	public static GameDriver driver_sf2rb	   = new GameDriver("1992"	,"sf2rb"	,"cps1.java"	,rom_sf2rb,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	"hack",  "Street Fighter II' - Champion Edition (Rainbow set 1)" )	// 920322 - based on World version
	public static GameDriver driver_sf2rb2	   = new GameDriver("1992"	,"sf2rb2"	,"cps1.java"	,rom_sf2rb2,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	"hack",  "Street Fighter II' - Champion Edition (Rainbow set 2)" )	// 920322 - based on World version
	public static GameDriver driver_sf2red	   = new GameDriver("1992"	,"sf2red"	,"cps1.java"	,rom_sf2red,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	"hack",  "Street Fighter II' - Champion Edition (Red Wave)" )		// 920313 - based on World version
	public static GameDriver driver_sf2v004	   = new GameDriver("1992"	,"sf2v004"	,"cps1.java"	,rom_sf2v004,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	"hack",  "Street Fighter II! - Champion Edition (V004)" )		// "102092" !!! - based on (heavily modified) World version
	public static GameDriver driver_sf2accp2	   = new GameDriver("1992"	,"sf2accp2"	,"cps1.java"	,rom_sf2accp2,driver_sf2ce	,machine_driver_sf2	,input_ports_sf2	,init_cps1	,ROT0	,	"hack",  "Street Fighter II' - Champion Edition (Accelerator Pt.II)" )  // 920313 - based on USA version
