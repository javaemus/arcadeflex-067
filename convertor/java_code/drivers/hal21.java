...
public class hal21
{
	...
	*/
	...
	//AT
	public static WriteHandlerPtr hal21_soundcommand_w = new WriteHandlerPtr() {public void handler(int offset, int data){
		soundlatch_w(0, data);
	...
	public static Memory_ReadAddress hal21_readmem_sound[]={
		...
		new Memory_ReadAddress( 0xa000, 0xa000, soundlatch_r ), //AT
		new Memory_ReadAddress( 0xc000, 0xc000, MRA_NOP ), // ack
		new Memory_ReadAddress(MEMPORT_MARKER, 0)
	};
	...
	public static Memory_WriteAddress hal21_writemem_sound[]={
		...
		new Memory_WriteAddress( 0xe002, 0xe002, MWA_NOP ), //AT: unknown
	...
	public static Memory_WriteAddress hal21_writemem_CPUA[]={
		...
		new Memory_WriteAddress( 0xc300, 0xc300, hal21_soundcommand_w ), //AT
	...
	public static GameDriver driver_hal21	   = new GameDriver("1985"	,"hal21"	,"hal21.java"	,rom_hal21,null	,machine_driver_hal21	,input_ports_hal21	,null	,ROT270	,	"SNK", "HAL21", GAME_IMPERFECT_COLORS | GAME_IMPERFECT_SOUND )
	public static GameDriver driver_hal21j	   = new GameDriver("1985"	,"hal21j"	,"hal21.java"	,rom_hal21j,driver_hal21	,machine_driver_hal21	,input_ports_hal21	,null	,ROT270	,	"SNK", "HAL21 (Japan)", GAME_IMPERFECT_COLORS | GAME_IMPERFECT_SOUND )
}
