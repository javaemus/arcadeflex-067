...
public class psikyosh
{
	...
	static InputPortPtr input_ports_gnbarich = new InputPortPtr(){ public void handler() {  /* Same as S1945iii except only one button */
	...
	static RomLoadPtr rom_gnbarich = new RomLoadPtr(){ public void handler(){ 
		ROM_REGION( 0x100000, REGION_CPU1, 0);
	...
	*/
	...
	/* ps3-v1 */
	public static GameDriver driver_soldivid	   = new GameDriver("1997"	,"soldivid"	,"psikyosh.java"	,rom_soldivid,null	,machine_driver_psikyo3v1	,input_ports_soldivid	,init_soldivid	,ROT0	,	"Psikyo", "Sol Divide - The Sword Of Darkness", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND ) // Music Tempo
	public static GameDriver driver_s1945ii	   = new GameDriver("1997"	,"s1945ii"	,"psikyosh.java"	,rom_s1945ii,null	,machine_driver_psikyo3v1	,input_ports_s1945ii	,init_s1945ii	,ROT270	,	"Psikyo", "Strikers 1945 II", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_daraku	   = new GameDriver("1998"	,"daraku"	,"psikyosh.java"	,rom_daraku,null	,machine_driver_psikyo3v1	,input_ports_daraku	,init_daraku	,ROT0	,	"Psikyo", "Daraku Tenshi - The Fallen Angels", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_sbomberb	   = new GameDriver("1998"	,"sbomberb"	,"psikyosh.java"	,rom_sbomberb,null	,machine_driver_psikyo3v1	,input_ports_sbomberb	,init_sbomberb	,ROT270	,	"Psikyo", "Space Bomber (ver. B)", GAME_IMPERFECT_GRAPHICS )
	
	/* ps5 */
	public static GameDriver driver_gunbird2	   = new GameDriver("1998"	,"gunbird2"	,"psikyosh.java"	,rom_gunbird2,null	,machine_driver_psikyo5	,input_ports_gunbird2	,init_gunbird2	,ROT270	,	"Psikyo", "Gunbird 2", GAME_IMPERFECT_GRAPHICS )
	public static GameDriver driver_s1945iii	   = new GameDriver("1999"	,"s1945iii"	,"psikyosh.java"	,rom_s1945iii,null	,machine_driver_psikyo5	,input_ports_s1945iii	,init_s1945iii	,ROT270	,	"Psikyo", "Strikers 1945 III (World) / Strikers 1999 (Japan)", GAME_IMPERFECT_GRAPHICS )
	
	/* ps5v2 */
	public static GameDriver driver_dragnblz	   = new GameDriver("2000"	,"dragnblz"	,"psikyosh.java"	,rom_dragnblz,null	,machine_driver_psikyo5	,input_ports_dragnblz	,init_dragnblz	,ROT270	,	"Psikyo", "Dragon Blaze", GAME_IMPERFECT_GRAPHICS | GAME_IMPERFECT_SOUND ) // incomplete dump
	public static GameDriver driver_gnbarich	   = new GameDriver("2001"	,"gnbarich"	,"psikyosh.java"	,rom_gnbarich,null	,machine_driver_psikyo5	,input_ports_gnbarich	,init_gnbarich	,ROT270	,	"Psikyo", "Gunbarich", GAME_IMPERFECT_GRAPHICS )
}
