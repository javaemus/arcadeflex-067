...
public class nemesis
{
	...
	***************************************************************************/
	...
	public static GameDriver driver_nemesis	   = new GameDriver("1985"	,"nemesis"	,"nemesis.java"	,rom_nemesis,null	,machine_driver_nemesis	,input_ports_nemesis	,null	,ROT0	,	"Konami", "Nemesis", GAME_NO_COCKTAIL )
	public static GameDriver driver_nemesuk	   = new GameDriver("1985"	,"nemesuk"	,"nemesis.java"	,rom_nemesuk,driver_nemesis	,machine_driver_nemesis	,input_ports_nemesuk	,null	,ROT0	,	"Konami", "Nemesis (World?)", GAME_NO_COCKTAIL )
	public static GameDriver driver_konamigt	   = new GameDriver("1985"	,"konamigt"	,"nemesis.java"	,rom_konamigt,null	,machine_driver_konamigt	,input_ports_konamigt	,null	,ROT0	,	"Konami", "Konami GT", GAME_NO_COCKTAIL )
	public static GameDriver driver_rf2	   = new GameDriver("1985"	,"rf2"	,"nemesis.java"	,rom_rf2,driver_konamigt	,machine_driver_rf2_gx400	,input_ports_rf2	,null	,ROT0	,	"Konami", "Konami RF2 - Red Fighter", GAME_NO_COCKTAIL )
	public static GameDriver driver_twinbee	   = new GameDriver("1985"	,"twinbee"	,"nemesis.java"	,rom_twinbee,null	,machine_driver_twinbee_gx400	,input_ports_twinbee	,null	,ORIENTATION_SWAP_XY	,	"Konami", "TwinBee", GAME_NO_COCKTAIL )
	public static GameDriver driver_gradius	   = new GameDriver("1985"	,"gradius"	,"nemesis.java"	,rom_gradius,driver_nemesis	,machine_driver_gx400	,input_ports_gradius	,null	,ROT0	,	"Konami", "Gradius", GAME_NO_COCKTAIL )
	public static GameDriver driver_gwarrior	   = new GameDriver("1985"	,"gwarrior"	,"nemesis.java"	,rom_gwarrior,null	,machine_driver_gx400	,input_ports_gwarrior	,null	,ROT0	,	"Konami", "Galactic Warriors", GAME_NO_COCKTAIL )
